...
export const en = {
  ...
  "nav.setup": "Setup",
  "nav.setupHint": "Set up once, or once a year",
  ...
  "pdf.refund.paidTo": "Refunded to",
  "pdf.receipt.amount": "Amount received",
  "pdf.refund.amount": "Amount refunded",
  "pdf.receipt.method": "Paid by",
  "pdf.receipt.reference": "Reference",
  "pdf.receipt.againstInvoice": "Against invoice",
  "pdf.receipt.onAccount": "Paid on account, not against a particular invoice",
  "pdf.receipt.reversed": "This receipt was reversed on",
  ...
  "apply.title": "Apply to {college}",
  "apply.subtitle": "For the {session} academic year. You do not need an account — the admissions office will contact you about the next steps.",
  "apply.closed.title": "Applications are not open",
  "apply.closed.body": "This college is not taking applications online at the moment. Please contact the college directly.",
  "apply.section.child": "About the child",
  "apply.section.contact": "Who should the college contact?",
  "apply.firstName": "First name",
  "apply.lastName": "Last name",
  "apply.dateOfBirth": "Date of birth",
  "apply.gender": "Gender",
  "apply.gender.choose": "Choose…",
  "apply.gender.male": "Male",
  "apply.gender.female": "Female",
  "apply.gender.other": "Other",
  "apply.gender.undisclosed": "Prefer not to say",
  "apply.classLevel": "Class applying for",
  "apply.classLevel.none": "Not sure yet",
  "apply.contactName": "Your name",
  "apply.relationship": "Relationship to the child",
  "apply.relationshipHint": "For example: mother, father, guardian, or self.",
  "apply.phone": "Phone number",
  "apply.email": "Email address",
  "apply.contactHint": "Give at least one, so the college can reply.",
  "apply.notes": "Anything the college should know",
  "apply.optional": "optional",
  "apply.submit": "Send application",
  "apply.submitting": "Sending…",
  "apply.privacy": "Your details go only to the admissions office of {college}.",
  "apply.done.title": "Application received",
  "apply.done.body": "{college} has your application. Keep this reference number — the office will ask for it when they contact you.",
  ...
  "apply.error.firstName": "Enter the child's first name.",
  "apply.error.contactName": "Enter your name.",
  "apply.error.contact": "Give a phone number or an email address.",
  "apply.error.phone": "Use digits, spaces and + only.",
  "apply.error.email": "That email address does not look right.",
  ...
  "onlineTests.title": "Online tests",
  "onlineTests.subtitle": "Multiple-choice tests for your classes, marked the moment a student hands in.",
  "onlineTests.familySubtitle": "Tests set for your class. Each one has a clock that starts when you begin.",
  "onlineTests.noAccess": "Your role does not include online tests.",
  "onlineTests.empty": "No tests yet. Set one for a class you teach.",
  "onlineTests.familyEmpty": "No online tests have been set for your class.",
  "onlineTests.state.not_started": "Not started",
  "onlineTests.state.in_progress": "In progress",
  "onlineTests.state.submitted": "Submitted",
  "onlineTests.state.lapsed": "Time ran out",
